(function () {
		...
		! function () {
			...
			var r, s = {
				...
				each: function (e, n, i) {
					if (null != e)
						...
						for (var r = 0, s = e.length; r < s; r++) n.call(i, e[r], r, e);
					else
						for (var o in e) this.has(e, o) && n.call(i, e[o], o, e)
				},
				once: function (t) {
					var e, n = !1;
					return function () {
			...
			r = {
				...
				off: function (t, e, n) {
					...
					for (f = 0, a = (l = t ? [t] : s.keys(this._events)).length; f < a; f++)
						if (t = l[f], o = this._events[t]) {
							if (this._events[t] = i = [], e || n)
								for (h = 0, u = o.length; h < u; h++) r = o[h], (e && e !== r.callback && e !== r.callback._callback || n && n !== r.context) && i.push(r);
		...
		(function (global) {
			(function () {
				...
				function c(t, r) {
					...
					var o = t.Number || n.Number,
						i = t.String || n.String,
						a = t.Object || n.Object,
						l = t.Date || n.Date,
						f = t.SyntaxError || n.SyntaxError,
						...
						if ("bug-string-char-index" == t) e = "a" != "a" [0];
							...
							if ("json-stringify" == t) {
								...
								if (f) {
									...
									try {
										f = "0" === a(0) && "0" === a(new o) && '""' == a(new i) && a(j) === y && a(y) === y && a() === y && "1" === a(n) && "[1]" == a([n]) && "[null]" == a([y]) && "null" == a(null) && "[null,null,null]" == a([y, j, null]) && a({
											a: [n, !0, !1, null, "\0\b\n\f\r\t"]
					...
					if (!v("json")) {
						...
						if ((p = b.hasOwnProperty) || (p = function (t) {
								...
								return n = o = null, i ? g = 2 == i ? function (t, e) {
									...
									var n, c, i = "[object Function]" == j.call(t),
										a = !i && "function" != typeof t.constructor && e[typeof t.hasOwnProperty] && t.hasOwnProperty || p;
				...
				if (!o || o.global !== o && o.window !== o && o.self !== o || (n = o), r && !t) c(n, r);
				else {
					var i = n.JSON,
						a = n.JSON3,
						l = !1,
	...
	7: [function (require, module, exports) {
		...
		function arrayLikeKeys(r, e) {
			var t = isArray(r) || isArguments(r) ? baseTimes(r.length, String) : [],
				n = t.length,
				o = !!n;
		...
		function baseRest(r, e) {
			return e = nativeMax(void 0 === e ? r.length - 1 : e, 0),
				function () {
		...
		var assign = createAssigner(function (r, e) {
			if (nonEnumShadows || isPrototype(e) || isArrayLike(e)) copyObject(e, keys(e), r);
			else
	...
	9: [function (require, module, exports) {
		(function (global) {
			...
			function arrayIncludesWith(e, t, r) {
				for (var a = -1, n = e ? e.length : 0; ++a < n;)
					if (r(t, e[a])) return !0;
				return !1
			}
			...
			function arrayLikeKeys(e, t) {
				var r = isArray(e) || isArguments(e) ? baseTimes(e.length, String) : [],
					a = r.length,
					n = !!a;
	...
	16: [function (require, module, exports) {
		...
		}, Event.prototype.stopPropagation = function () {}, Event.prototype.preventDefault = function () {}, Event.CAPTURING_PHASE = 1, Event.AT_TARGET = 2, Event.BUBBLING_PHASE = 3, module.exports = Event;
	...
	24: [function (require, module, exports) {
		...
		"./info-ajax": 21,
		"./info-iframe": 23,
		"./transport/sender/xdr": 46,
		"./transport/sender/xhr-cors": 47,
		"./transport/sender/xhr-fake": 48,
		"./transport/sender/xhr-local": 49,
		"./utils/url": 64,
		"_process": 10,
		"debug": 66,
	...
	26: [function (require, module, exports) {
		(function (process, global) {
			"use strict";
			require("./shims");
			var transports, URL = require("url-parse"),
				inherits = require("inherits"),
				JSON3 = require("json3"),
			...
			function SockJS(t, e, r) {
				...
				var s = r.sessionId || 8;
				if ("function" == typeof s) this._generateSessionId = s;
				else {
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:main")), inherits(SockJS, EventTarget), SockJS.prototype.close = function (t, e) {
				...
				for (var t = this._transports.shift(); t; t = this._transports.shift()) {
					...
					var r = urlUtils.addPath(this._transUrl, "/" + this._server + "/" + this._generateSessionId()),
						s = this._transportOptions[t.transportName];
	...
	27: [function (require, module, exports) {
		"use strict";
		var defineProperty, ArrayPrototype = Array.prototype,
		...
		defineProperty = supportsDescriptors ? function (t, r, e, n) {
			!n && r in t || Object.defineProperty(t, r, {
				configurable: !0,
				enumerable: !1,
				writable: !0,
				value: e
		...
		var boxedString = Object("a"),
			...
			properlyBoxesContext = function (t) {
				var r = !0,
					e = !0;
		...
		defineProperties(ArrayPrototype, {
			forEach: function (t) {
				var r = toObject(this),
					e = splitString && isString(this) ? this.split("") : r,
					n = arguments[1],
					i = -1,
					o = e.length >>> 0;
		...
		defineProperties(ArrayPrototype, {
			indexOf: function (t) {
				var r = splitString && isString(this) ? this.split("") : toObject(this),
					e = r.length >>> 0;
				if (!e) return -1;
				var n = 0;
				for (arguments.length > 1 && (n = toInteger(arguments[1])), n = n >= 0 ? n : Math.max(0, e + n); n < e; n++)
		...
		2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? function () {
			...
			StringPrototype.split = function (r, e) {
				...
				var i, o, s, p, c = [],
					l = (r.ignoreCase ? "i" : "") + (r.multiline ? "m" : "") + (r.extended ? "x" : "") + (r.sticky ? "y" : ""),
					a = 0;
				for (r = new RegExp(r.source, l + "g"), n += "", t || (i = new RegExp("^" + r.source + "$(?!\\s)", l)), e = void 0 === e ? -1 >>> 0 : ToUint32(e);
					(o = r.exec(n)) && !((s = o.index + o[0].length) > a && (c.push(n.slice(a, o.index)), !t && o.length > 1 && o[0].replace(i, function () {
	...
	28: [function (require, module, exports) {
		...
		"./transport/eventsource": 32,
		"./transport/htmlfile": 33,
		"./transport/jsonp-polling": 35,
		"./transport/lib/iframe-wrap": 38,
		"./transport/websocket": 50,
		"./transport/xdr-polling": 51,
		"./transport/xdr-streaming": 52,
		"./transport/xhr-polling": 53,
		"./transport/xhr-streaming": 54
	}],
	29: [function (require, module, exports) {
		(function (process, global) {
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:browser:xhr")), inherits(AbstractXHRObject, EventEmitter), AbstractXHRObject.prototype._start = function (t, e, i, r) {
				...
				if (r && r.noCredentials || !AbstractXHRObject.supportsCORS || (debug("withCredentials"), this.xhr.withCredentials = !0), r && r.headers)
					for (var n in r.headers) this.xhr.setRequestHeader(n, r.headers[n]);
				...
				if (debug("cleanup"), this.xhr) {
					if (this.removeAllListeners(), utils.unloadDel(this.unloadRef), this.xhr.onreadystatechange = function () {}, this.xhr.ontimeout && (this.xhr.ontimeout = null), t) try {
						this.xhr.abort()
					} catch (t) {}
	...
	34: [function (require, module, exports) {
		(function (process) {
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:transport:iframe")), inherits(IframeTransport, EventEmitter), IframeTransport.prototype.close = function () {
				...
				debug("postMessage", e, t), this.iframeObj.post(JSON3.stringify({
		...
		(function (process) {
			...
			function createAjaxSender(e) {
				return function (r, n, t) {
					...
					var s = urlUtils.addPath(r, "/xhr_send"),
						a = new e("POST", s, n, i);
	...
	39: [function (require, module, exports) {
		(function (process) {
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:polling")), inherits(Polling, EventEmitter), Polling.prototype._scheduleReceiver = function () {
				...
				var e = this,
					i = this.poll = new this.Receiver(this.receiveUrl, this.AjaxObject);
	...
	41: [function (require, module, exports) {
		(function (process) {
			...
			function EventSourceReceiver(e) {
				...
				var t = this,
					r = this.es = new EventSourceDriver(e);
	...
	43: [function (require, module, exports) {
		(function (process, global) {
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:receiver:jsonp")), inherits(JsonpReceiver, EventEmitter), JsonpReceiver.prototype.abort = function () {
				...
				var t, r = this,
					i = this.script = global.document.createElement("script");
				if (i.id = "a" + random.string(8), i.src = e, i.type = "text/javascript", i.charset = "UTF-8", i.onerror = this._scriptError.bind(this), i.onload = function () {
					...
					}, void 0 === i.async && global.document.attachEvent)
					if (browser.isOpera())(t = this.script2 = global.document.createElement("script")).text = "try{var a = document.getElementById('" + i.id + "'); if(a)a.onerror();}catch(x){};", i.async = t.async = !1;
					else {
						try {
	...
	44: [function (require, module, exports) {
		(function (process) {
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:receiver:xhr")), inherits(XhrReceiver, EventEmitter), XhrReceiver.prototype._chunkHandler = function (e, i) {
				if (debug("_chunkHandler", e), 200 === e && i)
	...
	45: [function (require, module, exports) {
		(function (process, global) {
			"use strict";
			var form, area, random = require("../../utils/random"),
				urlUtils = require("../../utils/url"),
				debug = function () {};
	...
	50: [function (require, module, exports) {
		(function (process) {
			...
			function WebSocketTransport(e, t, s) {
				...
				var r = this,
					o = urlUtils.addPath(e, "/websocket");
			...
			"production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:utils:iframe")), module.exports = {
				...
				postMessage: function (e, o) {
					global.parent !== global ? global.parent.postMessage(JSON3.stringify({
						...
						type: e,
						data: o || ""
					}), "*") : debug("Cannot postMessage, no parent window.", e, o)
				},
				createIframe: function (e, o) {
					var t, n, r = global.document.createElement("iframe"),
						l = function () {
				...
				createHtmlfile: function (e, o) {
					var t, n, r, l = ["Active"].concat("Object").join("X"),
						i = new global[l]("htmlfile"),
						u = function () {
	...
	67: [function (require, module, exports) {
		...
		function setup(e) {
			...
			return r.debug = r, r.default = r, r.coerce = function (e) {
				...
				var n, t;
				for (n = 0, t = r.skips.length; n < t; n++)
					if (r.skips[n].test(e)) return !1;
				for (n = 0, t = r.names.length; n < t; n++)
					if (r.names[n].test(e)) return !0;
				return !1
	...
	69: [function (require, module, exports) {
		(function (global) {
			...
			function lolcation(e) {
				var o, t = ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}).location || {},
					r = {},
					s = typeof (e = e || t);
				if ("blob:" === e.protocol) r = new Url(unescape(e.pathname), {});
				else if ("string" === s)
					for (o in r = new Url(e, {}), ignore) delete r[o];
				else if ("object" === s) {
	...
	70: [function (require, module, exports) {
		module.exports = {
			sockjsUrl: "https://api.scaledrone.com/v3/socket",
			websocketUrl: "wss://api.scaledrone.com/v3/websocket",
			websocketOptions: {
				origin: "http://websocket.org"
			},
			dbUrl: "https://api.scaledrone.com/db/v1",
			isBrowser: !0,
			SockJS: !0,
			type: "websocket"
		};
	...
	71: [function (require, module, exports) {
		...
		var Promise = require("lie"),
			...
			sockEvents = require("./sock_events.js"),
		...
		function Scaledrone(e, t) {
			...
			t = assign({}, {
				...
				data: null,
				debug: !1
			}, t), this.args = arguments, this.args[1] = t, this.originalInstance = t.originalInstance, this.readyState = States.CLOSED, this.callbackId = 0, this.callbacks = {}, this.rooms = {}, this.disconnected = !1, this.connection = getConnection(t), this.emitter = Events.mixin({}), sockEvents(this.connection, this.emitter, {
				debug: t.debug
			}), this.autoReconnect = t.autoReconnect, this.innerEmitter = Events.mixin({}), this.eventPromises = this.createEventPromises(), this.emitter.on("open", function () {
				r.readyState = States.OPEN, r._sendMessage("handshake", {
					channel: e,
					version: 2,
					client_data: t.data
				}, {}, function (e, t) {
				...
				if (-1 === ["observable_members", "observable_member_join", "observable_member_leave"].indexOf(t.type)) {
					...
					if (t.error) r.trigger("error", wrapError(t.error));
					else {
						if ("publish" === t.type) {
		...
		function reconnect(e, t, r) {
			...
			if (reconnectAttempt > 25) n.trigger("close", r);
			else {
				var i = 1e3 * reconnectAttempt++ * (Math.random() + .5);
				setTimeout(function () {
					var t = n.args,
						r = new Scaledrone(t[0], t[1]);
		...
		function getConnection(e) {
			return "sockjs" !== e.type && supportsWebsockets() ? isNode ? new config.WS(e.url || config.websocketUrl, config.websocketOptions) : new WebSocket(e.url || config.websocketUrl) : new config.SockJS(e.url || config.sockjsUrl, null, {
		...
		Events.mixin(Scaledrone.prototype), Scaledrone.prototype._trigger = function (e, t) {
			...
			return this.rooms[e] = r, this._sendMessage("subscribe", {
				room: e,
				history: t,
				history_count: t
			}, {
			...
			this.requireAuth && this.readyState !== States.AUTHENTICATED && (warn("Messages can be sent after authenticating"), t = {}), this._sendMessage("publish", {
				room: e.room,
				message: e.message
			}, t)
	...
	72: [function (require, module, exports) {
		...
		function Room(e, s, t) {
			var i = this,
				r = s.historyCount;
			this.name = e, this._history = {
				messages: [],
				nextIndex: 0
			}, this._historyCount = r, this.scaledrone = t, this._observable = isObservable(e), this._observable && (this._cache = [], this.on("members", function (e) {
